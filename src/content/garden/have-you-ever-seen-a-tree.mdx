...
image: ../../assets/garden/tree_optimized.webp
connections: [
  {
...
<div class={"flex flex-col items-center justify-center"}>
  <Image src={treeImage} alt="AI-generated tree taking multiple abstract forms in Dalí style" width={600} height={400} class="w-full max-w-2xl h-auto" />
