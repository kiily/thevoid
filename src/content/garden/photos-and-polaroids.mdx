...
connections: ["https://kiily.substack.com/p/photos-and-polaroids"]
---

import { Image } from "astro:assets";
import sunsetPhoneImage from "../../assets/garden/sunset-phone.webp";
import sunsetPrintedImage from "../../assets/garden/sunset-printed.webp";
...
<div class="flex flex-col md:flex-row gap-4 items-center justify-center">
  <div class="flex flex-col items-center">
    <Image src={sunsetPhoneImage} alt="Sunset with double rainbow - phone photo" width={300} height={400} />
    <figcaption class="mt-2 text-center text-sm text-garden-secondary dark:text-garden-dark-secondary font-body">Phone photo</figcaption>
  </div>
  <div class="flex flex-col items-center">
    <Image src={sunsetPrintedImage} alt="Sunset with double rainbow - printed version" width={300} height={400} />
    <figcaption class="mt-2 text-center text-sm text-garden-secondary dark:text-garden-dark-secondary font-body">Printed version</figcaption>
  </div>
</div>
