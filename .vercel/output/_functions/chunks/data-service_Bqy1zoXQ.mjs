...
import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, p as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, q as renderUniqueStylesheet, s as renderScriptElement, t as createHeadAndContent, e as renderComponent } from './astro/server_BcgDXOCH.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Be7Lohtt.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_PLAUSIBLE_DOMAIN": "your-domain.com", "SITE": "https://your-domain.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_B8vHAfVx.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BqN2UmIW.mjs');
...
export { DataService as D, getCollection as g };
